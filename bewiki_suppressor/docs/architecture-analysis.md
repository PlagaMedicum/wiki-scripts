...
This is a blunt review of the current `bewiki_suppressor` structure. It now mixes historical critique with the remaining architecture debt that still matters as the crate grows.

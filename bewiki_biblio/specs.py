...
from bewiki_biblio.utils import expand_macro_template, parse_regex_flags
...
def load_source_spec(source_id: str, root: Path | None = None) -> SourceSpec:
    ...
    normalization_options = NormalizationOptions(
        strip_nowiki=_optional_bool(normalization, "strip_nowiki", True),
        resolve_wikilinks=_optional_bool(normalization, "resolve_wikilinks", True),
        strip_formatting=_optional_bool(normalization, "strip_formatting", True),
        normalize_nbsp=_optional_bool(normalization, "normalize_nbsp", True),
        normalize_dashes=_optional_bool(normalization, "normalize_dashes", True),
        collapse_whitespace=_optional_bool(normalization, "collapse_whitespace", True),
    )
